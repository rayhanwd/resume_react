                ...
                <div className="md:flex  bg-gray-800 bg-opacity-40 p-6 rounded-lg">
                  ...
                  <div className="md:ml-5">
                    ...
                    <div className="link__share flex">
                      ...
                      <a href=""><svg xmlns="http://www.w3.org/2000/svg" className="text-white p-1 rounded-full bg-indigo-500 mt-5 relative h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <>
                        ...
                        <a href=""><svg xmlns="http://www.w3.org/2000/svg" className="rounded-full bg-indigo-500 text-white p-1 mt-5 relative h-6 w-6 ml-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
